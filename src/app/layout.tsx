...
export const metadata: Metadata = {
  metadataBase: new URL("https://aichatsupport.my"),
  title: {
    default: "AiChatSupport — AI Support Chatbot for your website & WhatsApp",
    template: "%s",
  },
  description:
