      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="md:sticky md:top-6 md:self-start">
          ...
          <div className="relative h-[420px] overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 dark:border-slate-800 dark:bg-slate-950">
            {/* mock chat panel */}
            <div className={`absolute bottom-16 w-56 overflow-hidden rounded-xl bg-white shadow-xl dark:bg-slate-900 ${appearance.position === "left" ? "left-4" : "right-4"}`}>
              <div className="px-3 py-2.5 text-sm font-semibold text-white" style={{ background: appearance.primary_color }}>
                {appearance.title || "Chat with us"}
              </div>
              <div className="space-y-2 p-3">
                <div className="max-w-[85%] rounded-lg rounded-bl-sm border border-slate-100 bg-white px-2.5 py-1.5 text-xs dark:border-slate-800 dark:bg-slate-800">
                  {appearance.greeting || "Hi! How can I help?"}
                </div>
                <div className="ml-auto max-w-[85%] rounded-lg rounded-br-sm px-2.5 py-1.5 text-xs text-white" style={{ background: appearance.primary_color }}>
                  Do you ship to Malaysia?
                </div>
              </div>
            </div>
            {/* mock launcher */}
            <div className={`absolute bottom-4 flex h-11 items-center rounded-full px-4 text-sm font-semibold text-white shadow-lg ${appearance.position === "left" ? "left-4" : "right-4"}`} style={{ background: appearance.primary_color }}>
