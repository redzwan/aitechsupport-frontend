...
.atsw-offerwrap { display: flex; flex-direction: column; align-items: flex-start; gap: 6px; }
.atsw-offer-alt { background: none; border: 0; padding: 0; color: var(--atsw-muted); font-size: 12px; text-decoration: underline; cursor: pointer; }
